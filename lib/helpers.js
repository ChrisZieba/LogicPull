...
exports.parseText = function (text, vars, data) {
	...
	text = text.replace(yre, function (match, identifier, hidden) {
		...
		modal.push('<a href="' + hidden + '" class="youtube-modal" data-toggle="modal" data-target="#youtube-modal-' + count + '">');
			modal.push(identifier);
		modal.push('</a>');

		modal.push('<div class="modal fade" id="youtube-modal-' + count + '" tabindex="-1" role="dialog" aria-hidden="true">');
