			...
			if (input_name && input_type) {
				...
				switch (input_type) {
					...
					case 'date':
						...
						output.push('<li><input type="text" id="' + input_name + '_picker" name="' + input_name + '" size="14" class="form-control notranslate" readonly="readonly" placeholder="Click to select" /></li>');
						output.push('</ul>');
