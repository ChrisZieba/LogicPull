...
function previous_answers (states) {
	...
	// the first one will be the last one answerd since they are sorted. This
	// might get more complicated when dealing with loops
	var state = states[states.length - 1];

	var vars = state.data.master.vars;
										// console.log("startes start");
										// console.log(vars);
										// console.log("states end");
