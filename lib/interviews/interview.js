			...
			if (input_name && input_type) {
				...
				switch (input_type) {
					...
					case 'date':
						...
						output.push('<li><input type="text" id="' + input_name + '_picker" name="' + input_name + '" size="14" class="form-control notranslate" readonly="readonly" /></li>');
						output.push('</ul>');
...
exports.done = function () {
	...
	output.push('<div class="col-lg-12 contents"><div class="well">'); 
