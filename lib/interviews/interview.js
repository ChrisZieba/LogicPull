...
function build (question, master, logic_debug, type, fields, data, answers) {
  ...
  var date_pickers = [];
  var max, min, values, field, label_class, input_name, input_type, input_label, input_default, input_validation, input_values, value, button, button_type, button_text, descending, size, line;
 ...
 * @destination {string} The question destination
 *
 */
exports.build = function (before_logic, data, fields, progress, state, states, destination) {
  "use strict";
