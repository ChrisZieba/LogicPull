  ...
  if (question.buttons) {
    output.push('<div class="row question-footer">');
      for (var r = 0; r < question.buttons.length; r+=1) {
        ...
        if (button_type === "exit") {
          output.push('<div id="exit-interview" class="' + button_type + '-button pull-right btn btn-danger notranslate" data-qid="' + question.qid + '">' + button_text + '</div>');
        } else if (button_type === "finish") {
          output.push('<div id="finish-interview" class="' + button_type + '-btn btn btn-success pull-right notranslate" data-loading-text="Loading..." autocomplete="off" data-qid="' + question.qid + '">' + button_text + '</div>');
        } else {
          output.push('<div class="' + button_type + '-button button btn btn-primary pull-right notranslate" data-loading-text="Loading..." autocomplete="off" data-qid="' + question.qid + '">' + button_text + ' <i class="fa fa-arrow-circle-o-right"></i></div>');
        }
      }
    output.push('</div>');
    output.push('<div class="clear"></div>');
